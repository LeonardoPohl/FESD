...
% A plethora of methods have been developed to estimate the pose of a human. In this section, $ will discuss some of the methods that have been developed to estimate the pose of a human. Additionally, $ discuss datasets that have been developed to test the performance of the methods. Finally, $ discuss some of the methods that have been developed to estimate the fault.
...
% While OpenPose developed Hand Pose\cite{OpenPoseHand} and also Multi-Person Human Pose Estimation \cite{OpenPoseMulti}, $ main focus lies on their most recent pose estimator \cite{OpenPosePose} and their CNN network \cite{OpenPoseCNN}. Openpose uses affinity fields. The affinity fields are a set of 2D Gaussian distributions that are used to estimate the pose of a human. The affinity fields are used to estimate the pose of a human by estimating the probability of a joint being in a certain location. The probability of a joint being in a certain location is calculated by summing the probability of the joint being in that location for each of the Gaussian distributions.
...
% But $ wont go into much detail as $ focus on RGBD data.
